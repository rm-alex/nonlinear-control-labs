...
\begin{align*}
    ...
    &(1;-1),(-1;1):\lambda_{A_{2,3}\, 1,2}=\left\{4.83, -0.83\right\} \text{ -- седло (неуст.)}
\end{align*}
...
$$
\begin{cases}
        \dot{x}_1|_{r=1}=\left( x_1-x_2 \right)\left( 1-1 \right),\\
        \dot{x}_2|_{r=1}=\left( x_1+x_2 \right)\left( 1-1 \right)
    \end{cases}\Rightarrow\begin{cases}
        \dot{x}_1|_{r=1}=0,\\
        \dot{x}_2|_{r=1}=0
    \end{cases}
...
Проверим устойчивость множества равновесий по радиальному направлению. Введем малое отклонение:
$$
...
При $r\to0$ степенные члены отрицательны, возмущение $O\left( r^5 \right)$ мало:
$$
\dot{V}<0
$$
...
Матрица $A$ и ее собственные числа:
$$
A=J|_{\left( 0;0;0 \right)}=\begin{bmatrix}
    0     &0     &0\\
     1     &0     &3\\
    -1     &0     &0
\end{bmatrix},\ \lambda_{1,2}=\left\{ 0,0,0 \right\}
$$
